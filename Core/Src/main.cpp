...
static void MX_GPIO_Init(void)
{
	...
	/* USER CODE END MX_GPIO_Init_1 */
	  ...
	  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4|GPIO_PIN_9|GPIO_PIN_15, GPIO_PIN_RESET);

	  /*Configure GPIO pin Output Level */
	  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_6, GPIO_PIN_RESET);

	  /*Configure GPIO pins : Button_3_Pin Button_4_Pin Button_5_Pin */
	  GPIO_InitStruct.Pin = Button_3_Pin|Button_4_Pin|Button_5_Pin;
	  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
	  GPIO_InitStruct.Pull = GPIO_PULLUP;
	  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

	  /*Configure GPIO pins : PA4 PA9 PA15 */
...
/* USER CODE BEGIN Header_EPaperEntry */
/**
